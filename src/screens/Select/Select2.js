...
const Select2 = ({ navigation }) => {
    ...
    return (
        <ScrollView>
            ...
            <Text>A palavra <TextRed>"FROM"</TextRed> significa <TextBlue>"DE"</TextBlue>, ela que nos diz DE qual tabela nós queremos resgatar aqueles dados, nesse caso da tabela <TextBlue>"COMPRAS"</TextBlue>. Em outras palavras com o comando <TextRed>"SELECT * FROM COMPRAS"</TextRed> estamos dizendo ao banco de dados <TextBlue>"SELECIONE TODAS AS INFORMAÇÕES DA TABELA COMPRAS"</TextBlue>. Mas para casos em que as tabelas possuem muitas colunas, não é interessante utilizar o <TextRed>"*"</TextRed>, pois muitos dados seriam resgatados, e também na maioria dos casos nós não queremos ver todas as informações, apenas as que nos interessam.</Text>
            <ViewEnd>
                <Navigation 
